...
RSpec.describe Coordinates do
  describe "#valid?" do
    it "is true if in the first row and first column of the grid" do
      valid_row_column = "A1"
      grid = Grid.new
      coordinates = Coordinates.new(valid_row_column, grid)
    ...
    it "is false when after the last row of the grid" do
      invalid_row = "D1"
      grid = Grid.new
      coordinates = Coordinates.new(invalid_row, grid)
    ...
    it "is false when after the last column of the grid" do
      invalid_column = "B4"
      grid = Grid.new
      coordinates = Coordinates.new(invalid_column, grid)
    ...
    it "is false when input is not in the correct format" do
      invalid_format = "3A"
      grid = Grid.new
      coordinates = Coordinates.new(invalid_format, grid)
    ...
    it "is false when the first character is not upper case" do
      ...
      grid = Grid.new
      coordinates = Coordinates.new(invalid_lower_case, grid)
