require "spec_helper"
require_relative "../lib/player_turn.rb"
...
RSpec.describe PlayerTurn do
  describe "#get_valid_coordinate" do
     it "repeatedly asks for valid coordinate, returns the value when valid" do
      ...
      player_turn = PlayerTurn.new(invalid_format, grid, printer)
      allow(invalid_format).to receive(:gets).and_return("A6", "B7", "A1")
      coordinates = Coordinates.new(player_turn.get_initial_input)

      result = player_turn.get_valid_coordinate
